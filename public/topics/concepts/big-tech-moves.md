...
Big Tech Moves is the Austin AI Club track for major company strategy, compute deals, hardware, product-platform shifts, acquisitions, policy, energy, and infrastructure moves that change the AI builder landscape.

## Mentioned In

- [[Austin AI Club - August 26, 2026]]: **Jalapeño posts its first silicon results**, **Gemma 4 31B hits 3,431 tok/s on Groq 3 LPX**, **NVIDIA prints $96.2B and guides $108B**, **Claude will watermark text globally for the EU AI Act**, and **Claudeforce puts Claude on Salesforce**.
...
- [[Austin AI Club - May 13, 2026]]: **Anthropic buys the AWS compute runway**, **Frontier model testing gets a federal lane**, and **Pentagon picks a classified AI stack**.
- [[Austin AI Club - April 15, 2026]]: **Anthropic vs OpenClaw keeps escalating**, **OpenAI acquires TBPN**, **Microsoft ships in-house MAI models**, **OpenAI pauses Stargate UK**, and **Two attacks on Sam Altman's home in one week**.
- [[Austin AI Club - April 1, 2026]]: **OpenAI closes new funding round**, **Sora app shutdown**, **MK-Ultrathink**, **White House pushes a national AI framework**, **OpenAI to acquire Astral**, **Meta and Intel chip push**, and **Tesla dodges AV regulation**.
- [[Austin AI Club - March 18, 2026]]: **Meta's "Moltbook"**, **Claude Kill?**, **Niantic turns Pokemon Go city data into robot navigation**, **MacBook Pro M5 Max as a local inference laptop**, **Confer + Meta private AI**, and **NemoClaw launch + OpenClaw reaction**.
