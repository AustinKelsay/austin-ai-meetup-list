...
- [[Austin AI Club - August 5, 2026]]: **Uncle Bob's senior job is constraints, not reading agent code** and **Cloudflare OS turns Sandstorm's grain model into agent-safe Gadgets**.
