...
- **Open model releases get specialized fast** - The last-two-week [[Open Models|open-model]] pass is a specialization story, not a rerun of June 24's [[GLM]], [[Kimi]], [[MiniMax]], or [[TMax]] slide. [[Qwen]] models agent environments, [[Mistral]] goes after Lean proofs, [[Cohere]] opens Arabic ASR, [[Microsoft]] safety-aligns Qwen with HARC, [[NVIDIA]] splits between [[Nemotron]] Puzzle compression and CWIP world-model evaluation, and [[DeepSeek]] turns [[Speculative Decoding|speculative decoding]] into an attachable module.
...
- **Proprietary releases split across agents and media** - [[OpenAI]] moved GPT-5.6 Sol/Terra/Luna toward a public July 9 launch and added GPT-Realtime-2.1/mini for voice agents, while [[Cursor]] and [[xAI|SpaceXAI]] pushed [[Grok]] 4.5, [[Cognition]] pushed SWE-1.7, [[Anthropic]] pushed Claude Sonnet 5, [[Google]] pushed [[Gemini]] Omni Flash, and [[Meta]] pushed Muse Image straight into product channels: IDE, Devin, Claude, voice, cloud media, Instagram, and WhatsApp.
