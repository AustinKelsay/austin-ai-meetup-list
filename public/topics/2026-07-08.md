...
- **Open model releases get specialized fast** - The theme is specialization: [[Qwen]] for agent-world simulation, [[Mistral]] for Lean proofs, [[Cohere]] for Arabic speech, [[Microsoft]] for Qwen safety tuning, [[NVIDIA]] for serving/eval models, and [[DeepSeek]] for faster decoding.
