...
- **Open model releases** - Thinking Machines opened the 975B/41B-active multimodal [[Inkling]] MoE; [[Qwen]] previewed Qwen3.8-Max; Bad Theory Labs shipped tool-using [[BTL-3]]; [[NVIDIA]] and [[Mistral]] pushed edge world/robot models; and [[Kimi]] K3 weights were due July 27—then the shelf filled with agent/reasoning MoEs, modality specialists, embedding models, and [[Local AI|local]] GGUF/NVFP4 packaging. [[Open Models|Open]] now spans frontier bases through laptop-shaped artifacts.
