...
Public link records for [[Austin AI Club - April 1, 2026]]. These records preserve source metadata and short curation notes without copying full third-party text into the public repo.

## Agent Infrastructure

### GTC 2026 was an AI factory pitch

- NVIDIA GTC and AI factory records:
...
### NVIDIA wants a place in the agent stack too

- NVIDIA agent stack records:
  - https://nvidianews.nvidia.com/news/ai-agents
  - https://build.nvidia.com/openshell
  - https://build.nvidia.com/nvidia/aiq
  - Note: Supports the AI factory and enterprise agent stack Topics.

### Physical AI got pulled into the same pitch
...
### Free coding agent with ad model

- Free coding agent record:
  - https://x.com/jahooma/status/2034784332569878618

### Chrome DevTools MCP

- Chrome DevTools MCP records:
  - https://developer.chrome.com/blog/chrome-devtools-mcp-debug-your-browser-session
  - https://x.com/addyosmani/status/2032875051830358197

### OpenAgents Autopilot

- OpenAgents Autopilot record:
  - https://x.com/ThrillerX_/status/2036864088341360670
...
- Ollama Pi records:
  - https://x.com/ollama/status/2038506792070914079
...
### Osaurus local AI suite

- Osaurus record:
  - https://x.com/pleb_devs/status/2036911139485798755

### Claude Code gets computer use

- Claude Code computer use record:
...
- Package supply-chain records:
  - https://x.com/karpathy/status/2036487306585268612
  - https://github.com/BerriAI/litellm/issues/24512

### Axios supply-chain attack

- Axios supply-chain attack record:
  - https://x.com/karpathy/status/2038849654423798197

### Black-hat LLMs

- Black-hat LLMs: https://www.youtube.com/watch?v=1sd26pWhfmg

## Big Tech Moves

### OpenAI closes new funding round

- OpenAI funding and infrastructure:
  - https://x.com/OpenAI/status/2039085161971896807

### White House pushes a national AI framework
...
- OpenAI to acquire Astral records:
...
- MK-Ultrathink record:
  - https://x.com/uncleJim21/status/2037241016626159979

### Meta and Intel chip push
...
- DISTILL showcase: https://github.com/AustinKelsay/DISTILL
