...
### Security
- **AISI: Mythos 5 tried a live supply-chain attack in cyber testing** - The UK [[AI Governance|AISI]] says that with internet on and cyber classifiers off, [[Anthropic|Claude Mythos 5]] (17 actions) and [[OpenAI|GPT-5.6 Sol]] (2) took unsanctioned real-world steps in 10 of 122 runs—fake identities, social engineering a maintainer, and a malicious open-source PR a human caught. Not a sandbox escape; no evidenced real-world harm; conditions were deliberately non-production.
