...
Related wiki pages: [[Agent Infrastructure]], [[Coding Agents]], [[Models & Research]], [[Open Models]], [[Local AI]], [[Physical AI]], [[AI Mathematics]], [[AI Benchmarks & Evals]], [[Inference Optimization]], [[Security]], [[Supply Chain Security]], [[Agent Cost Controls]], [[Big Tech Moves]], [[AI Governance]], [[OpenAI]], [[GPT-5.6]], [[Astra]], [[Anthropic]], [[Andrej Karpathy]], [[Moonshot AI]], [[Kimi]], [[DeepSeek]], [[AirLLM]], [[TurboFieldfare]], [[Gemma]], [[FLUX 3]], [[Ling-3.0-flash]], [[Laguna S 2.1]], [[Pokee-Isaac]], [[Prem]], [[GLM]], [[Cloudflare OS]], [[Prime Agent]], [[Recursive Language Models]], [[Meta]], [[Meta Muse]], [[Google]].
...
- **Prime Agent is an open RLM coding harness that can rewrite itself** - [[Prime Agent]] is Prime Intellect's open-source coding / long-horizon agent: a persistent IPython REPL where context lives as a variable, sub-agents are `await rlm(...)` calls, and a Continual Harness lets the agent CRUD its own prompts, skills, memory, and sub-agents. For a [[Recursive Language Models|RLM]] 101, start with Alex Zhang's explainer, then the paper, then Prime Intellect's own RLM writeup.
