...
- **Open model releases** - The open slide is now a stack, not a list: [[Nemotron]]/Cosmos/OmniDreams for [[Physical AI|physical AI]], [[Gemma]]/[[MiniMax]]/Liquid/Step/OpenBMB/Tencent/[[Cohere]] for local LLMs and coding agents, [[DiffusionGemma]] for text diffusion, PaddleOCR/LocateAnything for vision, MOSS/Higgs/dots for audio, Ideogram/Magenta/NAVA/Lance/Bernini/JoyAI for media, [[TMax]] for terminal-agent RL, WALL-OSS for robotics, and Unsloth/Comfy/NVFP4 quants for [[Inference Optimization|deployment]]. This is also an [[AI Signal Discovery|AI-source triage problem]] now.
